...
class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Vendor\\Library\\Generated\\Model\\NetworkSettings';
    }
    public function supportsNormalization($data, $format = null, array $context = array()): bool
    {
        return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\NetworkSettings';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('Ports', $data)) {
            ...
            foreach ($data['Ports'] as $key => $value) {
                ...
                foreach ($value as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'Vendor\\Library\\Generated\\Model\\PortBinding', 'json', $context);
                }
                $values[$key] = $values_1;
            }
        ...
        if (\array_key_exists('SecondaryIPAddresses', $data) && $data['SecondaryIPAddresses'] !== null) {
            ...
            foreach ($data['SecondaryIPAddresses'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Vendor\\Library\\Generated\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('SecondaryIPv6Addresses', $data) && $data['SecondaryIPv6Addresses'] !== null) {
            ...
            foreach ($data['SecondaryIPv6Addresses'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Vendor\\Library\\Generated\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('Networks', $data)) {
            ...
            foreach ($data['Networks'] as $key_1 => $value_4) {
                $values_4[$key_1] = $this->denormalizer->denormalize($value_4, 'Vendor\\Library\\Generated\\Model\\EndpointSettings', 'json', $context);
            }
    ...
    {
        return array('Vendor\\Library\\Generated\\Model\\NetworkSettings' => false);
    }
}
