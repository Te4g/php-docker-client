...
class SystemDfGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Vendor\\Library\\Generated\\Model\\SystemDfGetResponse200';
    }
    public function supportsNormalization($data, $format = null, array $context = array()): bool
    {
        return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\SystemDfGetResponse200';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('Images', $data)) {
            ...
            foreach ($data['Images'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Vendor\\Library\\Generated\\Model\\ImageSummary', 'json', $context);
            }
        ...
        if (\array_key_exists('Containers', $data)) {
            ...
            foreach ($data['Containers'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Vendor\\Library\\Generated\\Model\\ContainerSummary', 'json', $context);
            }
        ...
        if (\array_key_exists('Volumes', $data)) {
            ...
            foreach ($data['Volumes'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Vendor\\Library\\Generated\\Model\\Volume', 'json', $context);
            }
        ...
        if (\array_key_exists('BuildCache', $data)) {
            ...
            foreach ($data['BuildCache'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'Vendor\\Library\\Generated\\Model\\BuildCache', 'json', $context);
            }
    ...
    {
        return array('Vendor\\Library\\Generated\\Model\\SystemDfGetResponse200' => false);
    }
}
