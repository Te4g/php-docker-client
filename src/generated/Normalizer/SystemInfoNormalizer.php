...
class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Vendor\\Library\\Generated\\Model\\SystemInfo';
    }
    public function supportsNormalization($data, $format = null, array $context = array()): bool
    {
        return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\SystemInfo';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('Plugins', $data)) {
            $object->setPlugins($this->denormalizer->denormalize($data['Plugins'], 'Vendor\\Library\\Generated\\Model\\PluginsInfo', 'json', $context));
        }
        ...
        if (\array_key_exists('RegistryConfig', $data) && $data['RegistryConfig'] !== null) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data['RegistryConfig'], 'Vendor\\Library\\Generated\\Model\\RegistryServiceConfig', 'json', $context));
        ...
        if (\array_key_exists('GenericResources', $data)) {
            ...
            foreach ($data['GenericResources'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'Vendor\\Library\\Generated\\Model\\GenericResourcesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Runtimes', $data)) {
            ...
            foreach ($data['Runtimes'] as $key => $value_4) {
                $values_4[$key] = $this->denormalizer->denormalize($value_4, 'Vendor\\Library\\Generated\\Model\\Runtime', 'json', $context);
            }
        ...
        if (\array_key_exists('Swarm', $data)) {
            $object->setSwarm($this->denormalizer->denormalize($data['Swarm'], 'Vendor\\Library\\Generated\\Model\\SwarmInfo', 'json', $context));
        }
        ...
        if (\array_key_exists('ContainerdCommit', $data)) {
            $object->setContainerdCommit($this->denormalizer->denormalize($data['ContainerdCommit'], 'Vendor\\Library\\Generated\\Model\\Commit', 'json', $context));
        }
        if (\array_key_exists('RuncCommit', $data)) {
            $object->setRuncCommit($this->denormalizer->denormalize($data['RuncCommit'], 'Vendor\\Library\\Generated\\Model\\Commit', 'json', $context));
        }
        if (\array_key_exists('InitCommit', $data)) {
            $object->setInitCommit($this->denormalizer->denormalize($data['InitCommit'], 'Vendor\\Library\\Generated\\Model\\Commit', 'json', $context));
        }
        ...
        if (\array_key_exists('DefaultAddressPools', $data)) {
            ...
            foreach ($data['DefaultAddressPools'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'Vendor\\Library\\Generated\\Model\\SystemInfoDefaultAddressPoolsItem', 'json', $context);
            }
    ...
    {
        return array('Vendor\\Library\\Generated\\Model\\SystemInfo' => false);
    }
}
