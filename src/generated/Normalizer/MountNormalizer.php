...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class MountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\Mount::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\Mount::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\Mount();
            ...
            if (\array_key_exists('BindOptions', $data)) {
                $object->setBindOptions($this->denormalizer->denormalize($data['BindOptions'], \Vendor\Library\Generated\Model\MountBindOptions::class, 'json', $context));
            }
            if (\array_key_exists('VolumeOptions', $data)) {
                $object->setVolumeOptions($this->denormalizer->denormalize($data['VolumeOptions'], \Vendor\Library\Generated\Model\MountVolumeOptions::class, 'json', $context));
            }
            if (\array_key_exists('ImageOptions', $data)) {
                $object->setImageOptions($this->denormalizer->denormalize($data['ImageOptions'], \Vendor\Library\Generated\Model\MountImageOptions::class, 'json', $context));
            }
            if (\array_key_exists('TmpfsOptions', $data)) {
                $object->setTmpfsOptions($this->denormalizer->denormalize($data['TmpfsOptions'], \Vendor\Library\Generated\Model\MountTmpfsOptions::class, 'json', $context));
            }
            return $object;
        }
        ...
        {
            return [\Vendor\Library\Generated\Model\Mount::class => false];
        }
    }
} else {
    class MountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
