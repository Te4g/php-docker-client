...
class NetworkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Vendor\\Library\\Generated\\Model\\Network';
    }
    public function supportsNormalization($data, $format = null, array $context = array()): bool
    {
        return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\Network';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('IPAM', $data)) {
            $object->setIPAM($this->denormalizer->denormalize($data['IPAM'], 'Vendor\\Library\\Generated\\Model\\IPAM', 'json', $context));
        }
        ...
        if (\array_key_exists('Containers', $data)) {
            ...
            foreach ($data['Containers'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Vendor\\Library\\Generated\\Model\\NetworkContainer', 'json', $context);
            }
    ...
    {
        return array('Vendor\\Library\\Generated\\Model\\Network' => false);
    }
}
