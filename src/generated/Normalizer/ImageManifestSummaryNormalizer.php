...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ImageManifestSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\ImageManifestSummary::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\ImageManifestSummary::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\ImageManifestSummary();
            ...
            if (\array_key_exists('Size', $data)) {
                $object->setSize($this->denormalizer->denormalize($data['Size'], \Vendor\Library\Generated\Model\ImageManifestSummarySize::class, 'json', $context));
            }
            if (\array_key_exists('Kind', $data)) {
                $object->setKind($data['Kind']);
            }
            if (\array_key_exists('ImageData', $data) && $data['ImageData'] !== null) {
                $object->setImageData($this->denormalizer->denormalize($data['ImageData'], \Vendor\Library\Generated\Model\ImageManifestSummaryImageData::class, 'json', $context));
            }
            ...
            if (\array_key_exists('AttestationData', $data) && $data['AttestationData'] !== null) {
                $object->setAttestationData($this->denormalizer->denormalize($data['AttestationData'], \Vendor\Library\Generated\Model\ImageManifestSummaryAttestationData::class, 'json', $context));
            }
        ...
        {
            return [\Vendor\Library\Generated\Model\ImageManifestSummary::class => false];
        }
    }
} else {
    class ImageManifestSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
