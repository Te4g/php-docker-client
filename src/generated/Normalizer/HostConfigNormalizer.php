...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\HostConfig::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\HostConfig::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\HostConfig();
            ...
            if (\array_key_exists('BlkioWeightDevice', $data)) {
                ...
                foreach ($data['BlkioWeightDevice'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Vendor\Library\Generated\Model\ResourcesBlkioWeightDeviceItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceReadBps', $data)) {
                ...
                foreach ($data['BlkioDeviceReadBps'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Vendor\Library\Generated\Model\ThrottleDevice::class, 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceWriteBps', $data)) {
                ...
                foreach ($data['BlkioDeviceWriteBps'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \Vendor\Library\Generated\Model\ThrottleDevice::class, 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceReadIOps', $data)) {
                ...
                foreach ($data['BlkioDeviceReadIOps'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \Vendor\Library\Generated\Model\ThrottleDevice::class, 'json', $context);
                }
            ...
            if (\array_key_exists('BlkioDeviceWriteIOps', $data)) {
                ...
                foreach ($data['BlkioDeviceWriteIOps'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, \Vendor\Library\Generated\Model\ThrottleDevice::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Devices', $data)) {
                ...
                foreach ($data['Devices'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, \Vendor\Library\Generated\Model\DeviceMapping::class, 'json', $context);
                }
            ...
            if (\array_key_exists('DeviceRequests', $data)) {
                ...
                foreach ($data['DeviceRequests'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, \Vendor\Library\Generated\Model\DeviceRequest::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Ulimits', $data)) {
                ...
                foreach ($data['Ulimits'] as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, \Vendor\Library\Generated\Model\ResourcesUlimitsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('LogConfig', $data)) {
                $object->setLogConfig($this->denormalizer->denormalize($data['LogConfig'], \Vendor\Library\Generated\Model\HostConfigLogConfig::class, 'json', $context));
            }
            ...
            if (\array_key_exists('PortBindings', $data)) {
                ...
                foreach ($data['PortBindings'] as $key => $value_10) {
                    ...
                    foreach ($value_10 as $value_11) {
                        $values_11[] = $this->denormalizer->denormalize($value_11, \Vendor\Library\Generated\Model\PortBinding::class, 'json', $context);
                    }
            ...
            if (\array_key_exists('RestartPolicy', $data)) {
                $object->setRestartPolicy($this->denormalizer->denormalize($data['RestartPolicy'], \Vendor\Library\Generated\Model\RestartPolicy::class, 'json', $context));
            }
            ...
            if (\array_key_exists('Mounts', $data)) {
                ...
                foreach ($data['Mounts'] as $value_13) {
                    $values_13[] = $this->denormalizer->denormalize($value_13, \Vendor\Library\Generated\Model\Mount::class, 'json', $context);
                }
        ...
        {
            return [\Vendor\Library\Generated\Model\HostConfig::class => false];
        }
    }
} else {
    class HostConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
