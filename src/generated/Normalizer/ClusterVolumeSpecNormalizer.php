...
class ClusterVolumeSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Vendor\\Library\\Generated\\Model\\ClusterVolumeSpec';
    }
    public function supportsNormalization($data, $format = null, array $context = array()): bool
    {
        return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\ClusterVolumeSpec';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('AccessMode', $data)) {
            $object->setAccessMode($this->denormalizer->denormalize($data['AccessMode'], 'Vendor\\Library\\Generated\\Model\\ClusterVolumeSpecAccessMode', 'json', $context));
        }
        return $object;
    }
    /**
    ...
    {
        return array('Vendor\\Library\\Generated\\Model\\ClusterVolumeSpec' => false);
    }
}
