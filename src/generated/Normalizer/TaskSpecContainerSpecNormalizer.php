...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\TaskSpecContainerSpec::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\TaskSpecContainerSpec::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\TaskSpecContainerSpec();
            ...
            if (\array_key_exists('Privileges', $data)) {
                $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], \Vendor\Library\Generated\Model\TaskSpecContainerSpecPrivileges::class, 'json', $context));
            }
            ...
            if (\array_key_exists('Mounts', $data)) {
                ...
                foreach ($data['Mounts'] as $value_5) {
                    $values_5[] = $this->denormalizer->denormalize($value_5, \Vendor\Library\Generated\Model\Mount::class, 'json', $context);
                }
            ...
            if (\array_key_exists('HealthCheck', $data)) {
                $object->setHealthCheck($this->denormalizer->denormalize($data['HealthCheck'], \Vendor\Library\Generated\Model\HealthConfig::class, 'json', $context));
            }
            ...
            if (\array_key_exists('DNSConfig', $data)) {
                $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], \Vendor\Library\Generated\Model\TaskSpecContainerSpecDNSConfig::class, 'json', $context));
            }
            if (\array_key_exists('Secrets', $data)) {
                $values_7 = [];
                foreach ($data['Secrets'] as $value_7) {
                    $values_7[] = $this->denormalizer->denormalize($value_7, \Vendor\Library\Generated\Model\TaskSpecContainerSpecSecretsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Configs', $data)) {
                ...
                foreach ($data['Configs'] as $value_8) {
                    $values_8[] = $this->denormalizer->denormalize($value_8, \Vendor\Library\Generated\Model\TaskSpecContainerSpecConfigsItem::class, 'json', $context);
                }
            ...
            if (\array_key_exists('Ulimits', $data)) {
                ...
                foreach ($data['Ulimits'] as $value_12) {
                    $values_12[] = $this->denormalizer->denormalize($value_12, \Vendor\Library\Generated\Model\TaskSpecContainerSpecUlimitsItem::class, 'json', $context);
                }
        ...
        {
            return [\Vendor\Library\Generated\Model\TaskSpecContainerSpec::class => false];
        }
    }
} else {
    class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
