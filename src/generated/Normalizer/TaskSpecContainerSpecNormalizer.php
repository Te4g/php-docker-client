...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpec';
    }
    public function supportsNormalization($data, $format = null, array $context = array()): bool
    {
        return is_object($data) && get_class($data) === 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpec';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('Privileges', $data)) {
            $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        }
        ...
        if (\array_key_exists('Mounts', $data)) {
            ...
            foreach ($data['Mounts'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'Vendor\\Library\\Generated\\Model\\Mount', 'json', $context);
            }
        ...
        if (\array_key_exists('DNSConfig', $data)) {
            $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        }
        if (\array_key_exists('Secrets', $data)) {
            $values_7 = array();
            foreach ($data['Secrets'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Configs', $data)) {
            ...
            foreach ($data['Configs'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Ulimits', $data)) {
            ...
            foreach ($data['Ulimits'] as $value_12) {
                $values_12[] = $this->denormalizer->denormalize($value_12, 'Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpecUlimitsItem', 'json', $context);
            }
    ...
    {
        return array('Vendor\\Library\\Generated\\Model\\TaskSpecContainerSpec' => false);
    }
}
