...
class Client extends \Vendor\Library\Generated\Runtime\Client\Client
{
    ...
    */
    public function containerCreate(\Vendor\Library\Generated\Model\ContainersCreatePostBody $body, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
     ...
     *
     * @return null|\Vendor\Library\Generated\Model\ContainersIdJsonGetResponse200|\Psr\Http\Message\ResponseInterface
     */
    ...
    *
    * @return null|\Vendor\Library\Generated\Model\ContainersIdTopGetResponse200|\Psr\Http\Message\ResponseInterface
    */
    ...
    *
    * @return null|\Vendor\Library\Generated\Model\ContainersIdUpdatePostResponse200|\Psr\Http\Message\ResponseInterface
    */
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Vendor\Library\Generated\Endpoint\ImageInspect($name), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Vendor\Library\Generated\Endpoint\ImageHistory($name), $fetch);
    }
    /**
    ...
    */
     ...
     */
    public function imageCommit(\Vendor\Library\Generated\Model\ContainerConfig $containerConfig, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \Vendor\Library\Generated\Endpoint\ImageGet($name), $fetch);
    }
    /**
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function volumeUpdate(string $name, \Vendor\Library\Generated\Model\VolumesNamePutBody $body, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     *
     * @return null|\Vendor\Library\Generated\Model\NetworksCreatePostResponse201|\Psr\Http\Message\ResponseInterface
     */
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function nodeUpdate(string $id, \Vendor\Library\Generated\Model\NodeSpec $body, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function swarmUpdate(\Vendor\Library\Generated\Model\SwarmSpec $body, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    *
    * @return null|\Vendor\Library\Generated\Model\ServicesCreatePostResponse201|\Psr\Http\Message\ResponseInterface
    */
    public function serviceCreate(\Vendor\Library\Generated\Model\ServicesCreatePostBody $body, array $headerParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
    public function serviceUpdate(string $id, \Vendor\Library\Generated\Model\ServicesIdUpdatePostBody $body, array $queryParameters = array(), array $headerParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function secretUpdate(string $id, \Vendor\Library\Generated\Model\SecretSpec $body, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function configUpdate(string $id, \Vendor\Library\Generated\Model\ConfigSpec $body, array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
    ...
    public static function create($httpClient = null, array $additionalPlugins = array(), array $additionalNormalizers = array())
    {
        ...
        $normalizers = array(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Vendor\Library\Generated\Normalizer\JaneObjectNormalizer());
