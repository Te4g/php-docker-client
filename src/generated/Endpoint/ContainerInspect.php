...
class ContainerInspect extends \Vendor\Library\Generated\Runtime\Client\BaseEndpoint implements \Vendor\Library\Generated\Runtime\Client\Endpoint
{
     ...
     *
     * @return null|\Vendor\Library\Generated\Model\ContainerInspectResponse
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Vendor\Library\Generated\Model\ContainerInspectResponse', 'json');
        }
        if (404 === $status) {
